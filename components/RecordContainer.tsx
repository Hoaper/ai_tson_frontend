...
import { useVisualizeBars } from '@/libs/hooks/useAudioRecord';


export const RecordContainer = () => {
  const {handleRecord, isRecording, audioEl, canvasEl} = useVisualizeBars()
  ...
  return (
    <div
      ...
      <button
        ...
        {isRecording && (
                <canvas className="w-[500px] h-[500px] absolute top-1/2 -translate-x-1/2 -translate-y-1/2 left-1/2"  width="500" height="500" ref={canvasEl}></canvas>
        )}
      </button>
